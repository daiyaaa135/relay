...
/** GET /api/gaming-handhelds/models?brand=Nintendo - returns MODEL values for that brand from data/gaming-handhelds.csv */
export async function GET(request: NextRequest) {
  ...
  try {
    const csvPath = join(process.cwd(), 'data', 'gaming-handhelds.csv');
